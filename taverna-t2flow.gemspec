...
# -*- encoding: utf-8 -*-
# stub: taverna-t2flow 0.6.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2014-06-25"
  s.description = "This gem enables parsing of Taverna 2 workflows (.t2flow).  An example use would be the diagram generation for the model representing Taverna 2 workflows, as used in myExperiment."
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<taverna-t2flow>, [">= 0"])
      ...
      s.add_dependency(%q<taverna-t2flow>, [">= 0"])
